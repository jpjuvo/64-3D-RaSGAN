...
tex = bpy.data.textures.new("BlueTexture", 'IMAGE')
image_path = os.path.abspath('blue.jpg')
...
for i, obj in enumerate(obj_objects):
    ...
    print ('obj.data.materials count ' + str(len(obj.data.materials)))
